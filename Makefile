...
CFLAGS=-std=c89 -fPIC -O3 $(PYTHONCFLAGS) -Wall -Wextra -Wno-comments -Wno-unused-result -Wno-unused-parameter -I include -Dinline=__inline__ -DMQTTAsync_setConnectedCallback=MQTTAsync_setConnected
