...
CFLAGS_PY=-std=c99 -fPIC -O3 $(PYTHON_CFLAGS) -Wall -Wextra -Wno-unused-result -Wno-unused-parameter -I include -Dinline=__inline__ -D_BSD_SOURCE -DMQTTAsync_setConnectedCallback=MQTTAsync_setConnected
...
CFLAGS_LUA=-std=c99 -fPIC -O3 $(LUA_CFLAGS) -Wall -Wextra -Wno-unused-result -Wno-unused-parameter -I include -Dinline=__inline__ -D_BSD_SOURCE -DMQTTAsync_setConnectedCallback=MQTTAsync_setConnected
